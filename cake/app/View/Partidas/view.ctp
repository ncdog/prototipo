...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Editar Partida'), array('action' => 'edit', $partida['Partida']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Borrar Partida'), array('action' => 'delete', $partida['Partida']['id']), null, __('Seguro que deseas borrar # %s?', $partida['Partida']['id'])); ?> </li>
...
<div class="related">
	<h3><?php echo __('Relacionado a Presupuestos'); ?></h3>
	...
	<?php
		...
		<tr>
			...
			<td class="actions">
				...
				<?php echo $this->Form->postLink(__('Borrar'), array('controller' => 'presupuestos', 'action' => 'delete', $presupuesto['id']), null, __('Seguro que desaeas borrar # %s?', $presupuesto['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
