...
<div class="actions">
	...
	<ul>
        	<li><?php echo $this->Html->link(__('Editar Catalogo'), array('action' => 'edit', $catalogo['Catalogo']['id'])); ?> </li>
			<li><?php echo $this->Form->postLink(__('Borrar Catalogo'), array('action' => 'delete', $catalogo['Catalogo']['id']), null, __('Estas seguro que quieres borrarlo # %s?', $catalogo['Catalogo']['id'])); ?> </li>
            ...
            <li><?php echo $this->Html->link(__('Ver Departamentos'), array('controller' => 'catalogos', 'action' => 'index')); ?> </li>
	</ul>
</div>
<div class="related">
	<h3><?php echo __('Partidas Relacionadas'); ?></h3>
	...
	<?php
		...
		<tr>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('Ver'), array('controller' => 'partidas', 'action' => 'view', $partida['id'])); ?>
				<?php echo $this->Html->link(__('Editar'), array('controller' => 'partidas', 'action' => 'edit', $partida['id'])); ?>
				<?php echo $this->Form->postLink(__('Borrar'), array('controller' => 'partidas', 'action' => 'delete', $partida['id']), null, __('Estas seguro que quierees borrarlo # %s?', $partida['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
